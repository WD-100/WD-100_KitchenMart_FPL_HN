...
import $ from "jquery";
import convertNumber from "../../../Shared/Utils/ConvertCurrency";
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record, index) => {
                return (
                    <span>
                        {convertNumber(record.sale_price)}
                    </span>
                );
            }
        },
        ...
        },
        {
            ...
            render: (id) =>
                <div className="d-flex gap-2">
                    <Link className="btn btn-sm btn-primary" to={`/admin/products/detail/${id}`}>
                        Xem chi tiết
                    </Link>
