...
import $ from 'jquery';
import ConvertCurrency, {convertNumberToString} from "../../../Shared/Utils/ConvertCurrency";
...
function ListProductAttribute() {
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Bạn có chắc chắn muốn xóa?')) {
            await productAttributeService.adminDelete(id)
                .then((res) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'price',
            width: '10%',
            render: (price) => ConvertCurrency(price) || "",
        },
        {
            title: 'Giá mới',
            dataIndex: 'sale_price',
            width: '10%',
            render: (sale_price) => ConvertCurrency(sale_price) || "",
        },
        {
            title: 'Số lượng',
            dataIndex: 'quantity',
            width: '10%',
            render: (quantity) => convertNumberToString(quantity) || "",
        },
        {
            title: 'Thời gian tạo',
            dataIndex: 'createdAt',
        ...
        },
        {
            ...
            render: (id) =>
                <div className="d-flex gap-2 align-items-center justify-content-center">
                    <Link to={`/admin/product-attributes/detail/${id}`} className="btn btn-primary">
                        Xem chi tiết
                    </Link>
    ...
    const getListAttribute = async () => {
        await productAttributeService.adminList()
            .then((res) => {
                setData(res.data)
                setLoading(false)
            })
        ...
        <>
            ...
            <main id="main" className="main">
                <div className="pagetitle">
                    <h1>Danh sách thuộc tính sản phẩm</h1>
                    <nav>
