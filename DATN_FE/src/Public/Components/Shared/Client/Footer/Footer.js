            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-6 col-lg-3">
                        <div className="block-5 mb-5">
                            ...
                            <ul className="list-unstyled">
                                <li className="address">Km12 Đ. Cầu Diễn, Phúc Diễn, Bắc Từ Liêm, Hà Nội</li>
                                <li className="phone"><a href="tel://23923929210">+84 989 888 888</a></li>
                                <li className="email">support@kitchenmart.com</li>
                            </ul>
                        </div>
                ...
                <div className="row pt-5 mt-5 text-center">
                    <div className="col-md-12">
                        <p>
                            Bản quyền &copy;2024
                            Bảo lưu mọi quyền | Thiết kế bởi <Link
                            to="#" target="_blank" className="text-primary">KitchenMart</Link>
                        </p>
                    </div>
