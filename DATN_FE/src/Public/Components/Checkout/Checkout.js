...
function Checkout() {
    ...
    const changeDiscountPrice = (coupon) => {
        ...
        if (Number(priceMain) < Number(min_total)) {
            alert('Đơn hàng chưa đạt giá trị tối thiểu để sử dụng mã giảm giá: ' + ConvertCurrency(min_total));
            return;
        }
    ...
    function handleCoupon(coupon, priceMain) {
        ...
        let priceConvert = ConvertCurrency(price);
    ...
    const calcTotal = () => {
        ...
        totalCartItems.each(function () {
            ...
            totalCartItem = totalCartItem.replaceAll(',', '').replaceAll('.', '').replaceAll('đ', '');
        ...
        let totalConvert = ConvertCurrency(total);
                            ...
                            <div className="form-group row mb-5">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <input type="text" required className="form-control" id="c_phone"
                                           name="c_phone"
                                           placeholder="Số điện thoại" defaultValue={users.phone_number}/>
                                </div>
                            </div>
                                            ...
                                            return (<tr>
                                                ...
                                                <td className="product-total">
                                                    <strong className="totalCartItem"
                                                            data-total={cart.product_id.sale_price * cart.quantity}>
                                                        {ConvertCurrency(cart.product_id.sale_price * cart.quantity)}
                                                    </strong>
                                                </td>
                                            </tr>)
                                        })}
