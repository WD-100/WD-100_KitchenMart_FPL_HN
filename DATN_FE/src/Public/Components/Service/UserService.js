...
const API_ENDPOINT = {
    ADMIN_LIST_USER: "/api/admin/user/list",
    ADMIN_DETAIL_USER: "/api/admin/user/detail/",
...
class UserService {
    ...
    adminUpdateUser = (id, data) => {
        ...
        return axios.patch(BASE_URL_SERVER + API_ENDPOINT.ADMIN_UPDATE_USER + id, data, config);
    }
